...
{
    public AiModel(IHttpClientFactory httpClientFactory) : base(httpClientFactory)
    {
    ...
    public override IAsyncEnumerable<string> AnswerStream(string question, Dictionary<string, object>? parameters = null,
