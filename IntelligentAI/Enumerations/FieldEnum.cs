...
public class FieldEnum : Enumeration
{
    ...
    public static FieldEnum Topic = new FieldEnum(1, nameof(Topic), "articlesequenceid,_score,degree,title,contenttxt,url,updatetime,papername,markinfo,class1,createtime,tags,same_id,sameid3,articletype");
